...
import { hasCredentials, registerCredentials, validateCredentials, signSession, verifySession, hardenCredentialFilePermissions, changePassword, changeUsername, getUsername, normalizeUsername, getRequireLoopbackLogin, setRequireLoopbackLogin, MIN_PASSWORD_LENGTH, } from "./credential-store.js";
 ...
 * unless the administrator has flipped the persisted `requireLoopbackLogin`
 * switch, which withdraws the exemption so every address needs a session.
 * @param req - the incoming HTTP request.
