...
export function AuthSection(props) {
    ...
    return (_jsxs("div", { style: { display: 'flex', flexDirection: 'column', gap: 16, maxWidth: 460 }, children: [_jsxs("section", { style: cardStyle, children: [_jsx("h2", { style: { fontSize: 16, fontWeight: 600, margin: '0 0 4px', color: 'var(--dsw-alias-label-primary, #333)' }, children: "\u8D26\u53F7" }), _jsx("p", { style: { fontSize: 13, color: 'var(--dsw-alias-label-tertiary, #666)', margin: '0 0 12px' }, children: username !== undefined ? `当前登录：${username}` : '当前登录：管理员' }), _jsxs("div", { style: { position: 'relative', display: 'inline-block' }, children: [_jsx("button", { type: "button", onClick: () => setConfirmingSignOut(true), disabled: busy, style: { ...buttonStyle, background: 'none', borderColor: 'var(--dsw-alias-state-error-primary, #d4380d)', color: 'var(--dsw-alias-state-error-primary, #d4380d)' }, children: "\u9000\u51FA\u767B\u5F55" }), confirmingSignOut && (_jsxs("div", { role: "alertdialog", "aria-label": "\u786E\u8BA4\u9000\u51FA\u767B\u5F55", style: {
                                    position: 'absolute',
                                    top: 'calc(100% + 10px)',
                                    left: 0,
                                    zIndex: 10,
