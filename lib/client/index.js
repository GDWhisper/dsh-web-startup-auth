...
export function AuthSection(props) {
    ...
    return (_jsxs("div", { style: { display: 'flex', flexDirection: 'column', gap: 24, maxWidth: 420 }, children: [_jsxs("section", { children: [_jsx("h2", { style: { fontSize: 16, fontWeight: 600, margin: '0 0 4px' }, children: "\u8D26\u53F7" }), _jsx("p", { style: { fontSize: 13, color: '#666', margin: '0 0 12px' }, children: username !== undefined ? `当前登录：${username}` : '当前登录：管理员' }), _jsx("button", { type: "button", onClick: () => setConfirmingSignOut(true), disabled: busy, style: { ...buttonStyle, background: 'none', borderColor: '#d4380d', color: '#d4380d' }, children: "\u9000\u51FA\u767B\u5F55" }), confirmingSignOut && (_jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: 8, marginTop: 8 }, children: [_jsx("span", { style: { fontSize: 13, color: '#666' }, children: "\u9000\u51FA\u767B\u5F55\u5C06\u56DE\u5230\u767B\u5F55\u9875" }), _jsx("button", { type: "button", onClick: () => void signOut(), disabled: busy, style: { ...buttonStyle, padding: '4px 12px', background: '#d4380d', color: '#ffffff' }, children: "\u786E\u8BA4\u9000\u51FA" }), _jsx("button", { type: "button", onClick: () => setConfirmingSignOut(false), disabled: busy, style: { ...buttonStyle, padding: '4px 12px', background: 'none', borderColor: '#d9d9d9', color: '#333' }, children: "\u53D6\u6D88" })] }))] }), _jsxs("section", { children: [_jsx("h2", { style: { fontSize: 16, fontWeight: 600, margin: '0 0 12px' }, children: "\u4FEE\u6539\u5BC6\u7801" }), _jsxs("form", { onSubmit: (event) => {
