...
import { DEFAULT_SESSION_MAX_AGE_DAYS, isValidSessionMaxAgeDays, SESSION_MAX_AGE_CHOICES } from './session-limits.ts'
 ...
 */
export function setSessionMaxAgeDays(days: number): void {
  ...
  if (getSessionMaxAgeDays() === days) return
